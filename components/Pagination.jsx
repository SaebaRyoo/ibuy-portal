    ...
    <nav>
      <ul className="inline-flex items-center w-full px-10 gap-x-2">
        ...
        {currentPage !== 1 && previousPage !== 1 && (
          <li
            className="w-8 h-8 p-1 text-center transition-colors border-2 border-transparent cursor-pointer hover:text-cPink hover:border-cPink rounded-2xl"
            onClick={() => {
              changeRoute({ page: 1 })
              scrollToTop()
            }}
        ...
        <li
          className="cursor-pointer w-8 h-8 p-1.5 text-center bg-cPink text-white rounded-2xl"
          onClick={() => {
